...
<body>
	<div class="main" style="background-color: white;">
		<div class="easyui-panel" style="border-style: none;">
			<form id="jsps_shop_admin_category_categoryEdit_addchildrenForm" method="post" class="validate" enctype="multipart/form-data" >
				<table>
					<tr>
						<th>分类名称</th>
