...
<html>
  ...
  <body>
						...
						*/
						add:function(){
								d=$('<div id="jsp_admin_deptForm_dialog"/>').dialog({
									...
									closable:true,
									cache: false,    
									href: '${pageContext.request.contextPath}/jsps/admin/deptForm.jsp',  
									buttons:[{
										text:'保存',
										iconCls:'icon-save',
										handler:function(){
					...
					treegrid.treegrid(
									{
										...
										toolbar : '#jsps_admin_dept_toolbar',
											/*
											[ {
											text : "增加",
											iconCls : "icon-add",
										...
										*/
										onLoadSuccess : function(row, data) {
											...
											if (data.total == 0) {
												...
												//$.messager.show({ msg: "messager", position: 'bottomRight' });
	...
	<div id="jsps_admin_dept_toolbar" style="display: none;">
		<table>
			<tr>
			<s:if test="#session.sessionInfo.getSecurityUtil().havePermission('/deptAction!save.action')">
			...
			<s:if test="#session.sessionInfo.getSecurityUtil().havePermission('/deptAction!edit.action')">
				<td>
